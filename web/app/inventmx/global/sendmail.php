...
if ($type == "afiliate") {
  $type = "Afíliate";
  //'heberto@inventmx.com'
  $to = array('erika.aupart@inventmx.com','red@invent.mx','webmaster@inventmx.com','pedro@inventmx.com', 'sara@inventmx.com');
} else {
  $type = "Anúnciate";
  //'heberto@inventmx.com'
  $to = array('webmaster@inventmx.com','pedro@inventmx.com','kenneth@inventmx.com');
}
