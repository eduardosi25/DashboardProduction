  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->template = new Google_Service_Fusiontables_Template_Resource(
        ...
        array(
          'methods' => array(
            'delete' => array(
              'path' => 'tables/{tableId}/theme/{templateId}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'tableId' => array(
                  'location' => 'path',
...
class Google_Service_Fusiontables_Table_Resource extends Google_Service_Resource
{
   ...
   * Whether to also copy tabs, styles, and theme. Default is false.
...
class Google_Service_Fusiontables_Template_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves a list of theme. (template.listTemplate)
   *
   * @param string $tableId
   * Identifier for the table whose theme are being requested
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken
   * Continuation token specifying which results page to return. Optional.
   * @opt_param string maxResults
   * Maximum number of theme to return. Optional. Default is 5.
