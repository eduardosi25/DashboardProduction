jQuery(document).ready(function () {//Creeamos los tags script para las dependencias a utilizar
  ...
  //jQuery('head').append('<link rel="stylesheet" href="http://776561ea720ed80d100a-d15d7e8f8f7f4ad15567639aa98ea820.r76.cf2.rackcdn.com/bottom_imx_js.css"/>');
//  jQuery('head').append('<link rel="stylesheet" href="bottom_local.css"/>');
...
function renderButtom(feedData) {
    ...
    bottomTemplate = '<div id="bottom-imx-fixed" class="bottom-js bottom-black">\n\
                            <div class="bottom-top prelative">\n\
                                ...
                                <div class="bottom-top-links-wrapper">\n\
                                    ...
                                    <div class="bottom-top-links">\n\
                                        <a class="politicas-privacidad" href="#">Políticas de privacidad</a>\n\
                                        <a class="version-movil" href="#" style="visibility:hidden;">\n\
                                            <span>VERSIÓN MÓVIL</span>\n\
                                        </a>\n\
                                        <a class="terminos-condiciones" href="#">Condiciones de uso</a>\n\
                                        <div class="clear"></div>\n\
                                        <span class="copy">© 2014 InventMX. Todos los derechos reservados. Prohibida la reproducción total o parcial, incluyendo cualquier medio electrónico o magnético.</span>\n\
                                    </div>\n\
...
function buildLinks(){
    ...
    if(pa){
        jQuery(".politica-ambiental").attr("href",pp);
    }
    if(gm){
