...
print drupal_render( $form[ 'form_youtube_tv_delete_top' ]['submit'] );
...
print drupal_render( $form[ 'form_youtube_tv_delete_bottom' ]['submit'] );
print drupal_render( $form[ 'form_youtube_tv_delete_bottom' ]['bottom-return'] );
