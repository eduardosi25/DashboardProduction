 ...
 *   The form state.
 */
function rsvp_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['resp_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','rsvp'),
  ...
  $form['resp_settings']['slideshow']['slideshow_display'] = array(
    ...
    '#default_value' => theme_get_setting('slideshow_display','rsvp'),
  ...
  $form['resp_settings']['slideshow']['slide1']['slide1_desc'] = array(
    ...
    '#default_value' => theme_get_setting('slide1_desc','rsvp'),
  );
  $form['resp_settings']['slideshow']['slide1']['slide1_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide URL'),
    '#default_value' => theme_get_setting('slide1_url','rsvp'),
  );
  ...
  $form['resp_settings']['slideshow']['slide2']['slide2_desc'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide2_desc','rsvp'),
  );
  $form['resp_settings']['slideshow']['slide2']['slide2_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide URL'),
    '#default_value' => theme_get_setting('slide2_url','rsvp'),
  );
  ...
  $form['resp_settings']['slideshow']['slide3']['slide3_desc'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide3_desc','rsvp'),
  );
  $form['resp_settings']['slideshow']['slide3']['slide3_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide URL'),
    '#default_value' => theme_get_setting('slide3_url','rsvp'),
  );
  $form['resp_settings']['slideshow']['slideimage'] = array(
    '#markup' => t('To change the Slide Images, Replace the slide-image-1.jpg, slide-image-2.jpg and slide-image-3.jpg in the images folder of the R.S.V.P. theme folder.'),
  );
  ...
  $form['resp_settings']['socialicon']['socialicon_display'] = array(
    ...
    '#default_value' => theme_get_setting('socialicon_display','rsvp'),
    '#description'   => t("Check this option to show Social Icon. Uncheck to hide."),
  );
  $form['resp_settings']['socialicon']['twitter_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Twitter Profile URL'),
    '#default_value' => theme_get_setting('twitter_url', 'rsvp'),
  ...
  $form['resp_settings']['socialicon']['facebook_url'] = array(
    ...
    '#default_value' => theme_get_setting('facebook_url', 'rsvp'),
  ...
  $form['resp_settings']['socialicon']['googleplus_url'] = array(
    ...
    '#default_value' => theme_get_setting('googleplus_url', 'rsvp'),
	  '#description'   => t("Enter your Google+ Profile URL. Leave blank to hide."),
  );
  $form['resp_settings']['socialicon']['pinterest_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Pinterest Profile URL'),
    '#default_value' => theme_get_setting('pinterest_url', 'rsvp'),
    '#description'   => t("Enter your Pinterest Profile URL. Leave blank to hide."),
  );
  $form['resp_settings']['socialicon']['linkedin_url'] = array(
    '#type' => 'textfield',
    '#title' => t('LinkedIn Profile URL'),
    '#default_value' => theme_get_setting('linkedin_url', 'rsvp'),
