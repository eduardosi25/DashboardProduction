...
<div class="container" id="content-head">
  ...
  <header id="head" role="banner">
    ...
    <div class="twelve columns omega" id="headright">
      ...
      <?php if (theme_get_setting('socialicon_display', 'rsvp')): ?>
      <?php 
      $twitter_url = check_plain(theme_get_setting('twitter_url', 'rsvp')); 
      $facebook_url = check_plain(theme_get_setting('facebook_url', 'rsvp')); 
      $googleplus_url = check_plain(theme_get_setting('googleplus_url', 'rsvp')); 
      $pinterest_url = check_plain(theme_get_setting('pinterest_url', 'rsvp'));
      $linkedin_url = check_plain(theme_get_setting('linkedin_url', 'rsvp')); 
      $theme_path_social = base_path() . drupal_get_path('theme', 'rsvp');
      ?>
      <div id="socialbar">
        <ul class="social">
      ...
      <?php if ($pinterest_url): ?><li> <a href="<?php print $pinterest_url; ?>" target="_blank"> <span class="social-button-pinterest"> </span> </a> </li> <?php endif; ?>
      <?php if ($linkedin_url): ?><li> <a href="<?php print $linkedin_url; ?>" target="_blank"> <span class="social-button-linkedin"> </span> </a> </li> <?php endif; ?>
      <li> <a href="<?php print $front_page; ?>rss.xml"> <span class="social-button-rss"> </span> </a> </li>
        </ul>
      </div>
      <?php endif; ?>
...
<div class="container" id="content-contain">
  ...
  <?php if ($is_front): ?>
    <div class="container">
    <?php if (theme_get_setting('slideshow_display', 'rsvp')): ?>
      <!-- Slides -->
      <?php 
      $url1 = check_plain(theme_get_setting('slide1_url','rsvp')); $cap1 = check_markup(theme_get_setting('slide1_desc','rsvp'), 'full_html');
      $url2 = check_plain(theme_get_setting('slide2_url','rsvp')); $cap2 = check_markup(theme_get_setting('slide2_desc','rsvp'), 'full_html');
      $url3 = check_plain(theme_get_setting('slide3_url','rsvp')); $cap3 = check_markup(theme_get_setting('slide3_desc','rsvp'), 'full_html');
      ?>
     <div class="flexslider">
      <ul class="slides">
        <li>
          <a href="<?php print url($url1); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'rsvp') . '/images/slide-image-1.jpg'; ?>"/></a>
          <?php if ($cap1): ?> <div class="flex-caption"> <h3> <?php print $cap1; ?> </h3> </div>  <?php endif; ?>
        </li>
        <li>
          <a href="<?php print url($url2); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'rsvp') . '/images/slide-image-2.jpg'; ?>"/></a>
          <?php if ($cap2): ?> <div class="flex-caption"> <h3> <?php print $cap2; ?> </h3> </div> <?php endif; ?>
        </li>
        <li>
          <a href="<?php print url($url3); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'rsvp') . '/images/slide-image-3.jpg'; ?>"/></a>
 ...
 <div id="content" class="<?php print $contentwid; ?> columns">
  <div id="breadcrumbs"><?php if (theme_get_setting('breadcrumbs', 'rsvp')): ?><?php if ($breadcrumb): print $breadcrumb; endif;?><?php endif; ?></div>
