...
/**
 * @file
 * invent-links.func.php
 */

/**
 * Implements theme_invent_links().
 */
function theme_invent_links($variables) {
  ...
  if (count($links) > 0) {
    ...
    foreach ($links as $key => $link) {
      ...
      if (count($children) > 0) {
        ...
        $output .= theme('invent_links', array('links' => $children, 'attributes' => $attributes));
      }
      $output .= "</li>\n";
    }
    $output .= '</ul>';
