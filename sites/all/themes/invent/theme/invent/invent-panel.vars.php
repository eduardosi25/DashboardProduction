...
/**
 * @file
 * invent-panel.vars.php
 */

/**
 * Implements hook_preprocess_invent_panel().
 */
function invent_preprocess_invent_panel(&$variables) {
...
/**
 * Implements hook_process_invent_panel().
 */
function invent_process_invent_panel(&$variables) {
