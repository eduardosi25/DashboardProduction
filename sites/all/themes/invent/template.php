 ...
 * folder, Drush will think it is trying to invent core when it is invoked
 ...
 * @see _invent_theme()
 */
function invent_theme(&$existing, $type, $theme, $path) {
  invent_include($theme, 'theme/registry.inc');
  return _invent_theme($existing, $type, $theme, $path);
}
 ...
 */
invent_include('invent', 'theme/alter.inc');
